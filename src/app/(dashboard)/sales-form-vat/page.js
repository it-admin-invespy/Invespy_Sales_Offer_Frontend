...
// Importing new Component only for this form 
import CSVUpload from "@/components/VAT-Form/CSVUpload";
import InstallmentCSV from "@/components/VAT-Form/InstallmentCSV";
import InvisibleTable from "@/components/VAT-Form/InvisibleTable";
import PDFPage from "@/components/VAT-Form/PDFPage";
...
const CSV_SAMPLES = Object.freeze({
  projectUnits: {
    content: [
      "Project Name,Unit No,Floor No,Unit Type,View,Area (Sq/Ft),Price Excl. VAT (AED)",
